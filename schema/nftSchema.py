...
# import secrets
# from config.db import user, nft, rights
# from fastapi import HTTPException
...
#     if data["userLicenseCondition"] not in valid_license_conditions:
#         raise HTTPException(
#             status_code=400, detail="Please enter a valid license Condition"
#         )
...
#     if rights_exists:
#         # Check if the same rights are already given
#         for Category_rights in categories:
#             if data[Category_rights]["merchantQuantity"] == "":
#                 data[Category_rights]["merchantQuantity"] = 0
#             if rights_exists.get(Category_rights, {}).get("merchantQuantity", "") == "":
#                 rights_exists[Category_rights]["merchantQuantity"] = 0
#             if (
#                 int(data[Category_rights]["merchantQuantity"]) > 0
#                 and int(rights_exists[Category_rights]["merchantQuantity"]) > 0
#             ):
#                 raise HTTPException(
#                     status_code=400, detail="Rights already allocated for ${categories}"
#                 )
...
#                 raise HTTPException(
#                     status_code=400,
#                     detail=f"Please enter valid {category} Merch license Condition",
#                 )
...
#                     raise HTTPException(
#                         status_code=400,
#                         detail=f"Please select quantity between 100 and 1000 for {category}",
#                     )
#             else:
#                 data[category]["merchantQuantity"] = 0
...
#                 rights_exists[category] = data[category]
#             if rights_exists.get(category, {}).get("merchantQuantity", "") == 0:
#                 rights_exists[category] = data[category]
