...
@order.post(
    "/order/ecommerce/", tags=["order"], summary="Allow User to Purchase Ecommerce"
)
def read_root(data: OrderModel):
    """
    ### Allow user to purchase ecommerce
...
@order.patch(
    "/order/patch_ecommerce/", tags=["order"], summary="Allow Admin to Update Order"
)
